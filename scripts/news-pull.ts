...
async function main() {
  ...
  const guide = [
    ...
    '',
    '[정리 규칙 — 반드시 준수]',
    '- 분야별 2~3건(표준). 각 항목: title(한국어 한 줄 제목) · body(2~4문장 한국어 요약) · source(매체명 또는 URL).',
    ...
    '- 아래 [최근 저장된 헤드라인]과 같은 사안은, 새로운 전개가 있을 때만 다룬다(단순 반복 금지).',
    '- insight(선교 인사이트): 오늘 동향이 온두라스 선교·현지 사역·기도에 주는 함의 2~4문장. 건설적·중립 톤(특정 정파 편들기 금지), 기도/관심 포인트 1~2개 제시.',
    ...
    `  "news_date": "${today}",`,
    '  "sections": {',
    '    "politics": [{ "title": "한 줄 제목", "body": "2~4문장 요약", "source": "매체명/URL" }],',
    '    "economy":  [{ "title": "…", "body": "…", "source": "…" }],',
    '    "society":  [{ "title": "…", "body": "…", "source": "…" }],',
    '    "culture":  [{ "title": "…", "body": "…", "source": "…" }]',
    '  },',
    '  "highlights": [',
    '    { "tag": "San Pedro Sula", "title": "…", "body": "…", "source": "…" },',
    '    { "tag": "한인", "title": "…", "body": "…", "source": "…" }',
    '  ],',
    '  "insight": "오늘 동향의 선교적 함의 2~4문장 + 기도/관심 포인트."',
    '}',
    '',
    '═══════════════════════ 최근 저장된 헤드라인 (중복 회피용) ═══════════════════════',
    recentBlock,
