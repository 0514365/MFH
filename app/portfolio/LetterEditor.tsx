...
// MFH-PORTFOLIO-LETTER-EDITOR-V1
// 선교편지 관리 (편집 페이지, 영상 관리 아래).
// 추가 폼(년월·호수·제목 + PDF필수 + 표지선택 + 공개토글) + 리스트(공개표시·공유URL복사·순서·삭제).
        ...
        <ul className="space-y-2">
          {letters.map((l, i) => {
            ...
            return (
              <li
                key={l.id}
                className="flex items-center justify-between rounded-md border border-line bg-surface px-3 py-2.5"
              >
