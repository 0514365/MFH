  ...
  return (
    <section>
      ...
      >
        ...
        <span
          aria-hidden
          className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-full border text-ink transition ${
            open ? 'rotate-180 border-primary bg-surface-subtle' : 'border-line'
          }`}
        >
          <svg
            width="18"
