  ...
  return (
    <>
      ...
      >
        <Link
          href={`/p/${slug}/prayer`}
          className="mx-auto flex max-w-md items-center justify-center gap-2 rounded-xl bg-accent py-3 text-sm font-semibold text-white transition hover:opacity-90"
        >
