  ...
  return (
    <div className={saving ? 'pointer-events-none opacity-60' : ''}>
      <div className="mb-3">
        <div className="flex flex-wrap items-center gap-2">
          ...
          {filterActiveAny && (
            <button
              ...
              className="ml-auto inline-flex items-center gap-1 rounded-xl border border-accent px-3 py-1.5 text-xs font-semibold text-accent transition hover:bg-accent-soft"
            >
        ...
        {filterOpen && (
          <div className="mt-2 rounded-xl border border-line bg-surface-subtle p-2.5">
            <FilterChips wrap />
          </div>
        )}
      </div>
