                ...
                >
                  ...
                  <div className="mt-3 flex items-end justify-between gap-2 border-t border-line pt-3">
                    <div className="flex flex-col gap-1">
                      ...
                      <span className={`flex items-center gap-1.5 font-display text-[13px] font-bold tracking-wide ${p.due_date ? 'text-accent' : 'text-faint'}`}>
                    ...
                    <div className="flex flex-col items-end gap-1">
                      <span className="font-display text-[8px] font-bold uppercase tracking-[0.15em] text-faint">Tasks</span>
                      <span className="font-display text-[13px] font-bold text-ink">{c.done}/{c.total}</span>
                    </div>
                  </div>
                </div>
              </li>
