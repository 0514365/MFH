...
// 회선이 끊기면 정적 폴백 /offline.html 이 이 스냅샷을 직접 읽어 열람한다.
// (스키마는 public/offline.html 의 인라인 reader 와 반드시 일치시킬 것: DB 'mfh-offline' v1,
//  store 'kv'['journals'|'tasks' → {items,savedAt}] + 'thumbs'[path → Blob].)
