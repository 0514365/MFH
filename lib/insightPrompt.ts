...
export const LENS_FOCUS: Record<LensKey, string> = {
  ...
  letter:
    '한 달의 일지·프로젝트·할 일을 엮어 후원자에게 보내는 월간 기도편지 초안을 작성합니다. 온두라스 소식·사역 소식·선교사 가정 3단으로 구성하되 기록에 충실하게 쓰고, 정치는 중립을 지키며 사역 기도제목은 1~2개로 압축하고 가정의 평강·사전축복을 담습니다.',
}
...
- 감사의 언어로, 기록에 충실하게.`,
  letter: `[출력 형식 — 월간 기도편지 초안]
- 맨 위에 편지 번호를 'MFH #YYMM' 형식으로 적습니다(YY=분석 기간 종료 연도 끝 2자리, MM=종료 월 2자리).
- 본문은 굵은 번호 소제목 3단 구조이며, 각 단은 [굵은 번호 제목] + [맥락 문단 2~4문장] + [대시(-) 불릿 1~3개]로 구성합니다.
  **1. 온두라스 소식** — 현지 상황·이웃들. 정치는 정당·인물 거명 없이 항상 중립.
  **2. 사역 소식** — 교회·방과후·한글학교 등 주요 사역의 진행과 감사.
  **3. 선교사 가정** — 가족의 근황과 평강.
- 마지막에 "기도제목" 줄을 두고, 3원칙대로 압축한 사역 1~2개·가정·중립적 나라 기도를 대시 불릿으로 적습니다.
- 후원자에게 보내는 따뜻한 어조. 기록에 없는 사실은 지어내지 않고, 데이터가 부족하면 담백하게 적습니다.`,
}
